...
public class VaccineServiceImpl implements VaccineService {
    ...
    @Transactional
    public VaccineModel save(VaccineDTO dto) {
    ...
    @Transactional
    public VaccineModel update(UUID id, VaccineDTO dto) {
    ...
    public boolean existsByVolunteersId(UUID doctorId) {
        return repository.existsByVolunteersId(doctorId);
    }
}